...
pub fn create_worker_runtime(
    ...
    runtime
        ...
        .expect("worker: geometry bootstrap failed");
    ...
    runtime
        .execute_script("<anonymous>", include_str!("js/cache_storage_bootstrap.js"))
    ...
    runtime
        ...
        .expect("worker: emerging WebIDL bootstrap failed");
