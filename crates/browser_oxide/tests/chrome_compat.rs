    ...
    let result = check(
        r#"(() => {
            ...
            return JSON.stringify({
                ...
                pointerOrder:Object.getOwnPropertyNames(PointerEvent.prototype).slice(-5)
            });
        })()"#,
    )
    .await;
